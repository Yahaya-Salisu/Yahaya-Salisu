...
| [L-02](#[l-02]_Missing-validation-in-requestredeem(),-function-allows-owner-operator-or-bot-to-set-zero-address-as-controller-leading-to-permanent-loss-of-funds) | Missing validation in requestRedeem() function allows owner/operator or bot to set zero address as controller, leading to permanent loss of funds |
